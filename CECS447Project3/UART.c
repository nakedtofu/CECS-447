...
// Communication baud
  UART1_IBRD_R = 54;                    // IBRD = int(50,000,000 / (16 * 57600)) = int(54.253472)
  UART1_FBRD_R = 16;                     // FBRD = int(0.253472 * 64) = 16
// Setup baud
//  UART1_IBRD_R = 81;                    // IBRD = int(50,000,000 / (16 * 38400)) = int(81.3802083)
//  UART1_FBRD_R = 24;                     // FBRD = int(0.3802083 * 64) = 24
...
void UART0_Init(void){
  ...
  UART0_IBRD_R = 81;                    // IBRD = int(50,000,000 / (16 * 38400)) = int(81.3802083)
  UART0_FBRD_R = 24;                     // FBRD = int(0.3802083 * 64) = 24
                                        // 8 bit word length (no parity bits, one stop bit, FIFOs)
